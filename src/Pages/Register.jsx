...
const Register = () => {
    const { createUser, setLoading } = use(AuthContex);
    ...
    return (
        <div className="card bg-base-100 w-full max-w-md mx-auto shrink-0 shadow-2xl">
            <div className="card-body">
                ...
                <p className='text-center text-lg'>Already have an account? <Link to={'/auth'} className='gradient bg-clip-text text-transparent '> LogIn Now</Link></p>
                <form onSubmit={handelCreateuser}>
                    <fieldset className="fieldset">
                        ...
                        <button className="btn text-white gradient mt-4 text-base">Register</button>
